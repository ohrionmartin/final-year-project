...
class com_ehealth_portalInstallerScript
{
	...
	public function uninstall(JAdapterInstance $parent)
	{
		...
		$query->where( $db->quoteName('type_alias') . ' = '. $db->quote('com_ehealth_portal.group_health_education_topic') );
		$db->setQuery($query);
		// [Interpretation 8261] Execute query to see if alias is found
		$db->execute();
		...
		if ($group_health_education_topic_found)
		{
			...
			$group_health_education_topic_condition = array( $db->quoteName('type_alias') . ' = '. $db->quote('com_ehealth_portal.group_health_education_topic') );
			// [Interpretation 8287] Create a new query object.
			$query = $db->getQuery(true);
			$query->delete($db->quoteName('#__content_types'));
			...
			if ($group_health_education_topic_done)
			{
				...
				$app->enqueueMessage(JText::_('The (com_ehealth_portal.group_health_education_topic) type alias was removed from the <b>#__content_type</b> table'));
			}
			...
			if ($group_health_education_topic_done)
			{
				...
				$app->enqueueMessage(JText::_('The (com_ehealth_portal.group_health_education_topic) type alias was removed from the <b>#__contentitem_tag_map</b> table'));
			}

			// [Interpretation 8349] Remove Group_health_education_topic items from the ucm content table
			$group_health_education_topic_condition = array( $db->quoteName('core_type_alias') . ' = ' . $db->quote('com_ehealth_portal.group_health_education_topic') );
			// [Interpretation 8355] Create a new query object.
			$query = $db->getQuery(true);
			$query->delete($db->quoteName('#__ucm_content'));
			$query->where($group_health_education_topic_condition);
			...
			if ($group_health_education_topic_done)
			{
				...
				$app->enqueueMessage(JText::_('The (com_ehealth_portal.group_health_education_topic) type alias was removed from the <b>#__ucm_content</b> table'));
			}
		...
		$query->where( $db->quoteName('type_alias') . ' = '. $db->quote('com_ehealth_portal.individual_health_education_topic') );
		$db->setQuery($query);
		// [Interpretation 8261] Execute query to see if alias is found
		$db->execute();
		...
		if ($individual_health_education_topic_found)
		{
			...
			$individual_health_education_topic_condition = array( $db->quoteName('type_alias') . ' = '. $db->quote('com_ehealth_portal.individual_health_education_topic') );
			// [Interpretation 8287] Create a new query object.
			$query = $db->getQuery(true);
			$query->delete($db->quoteName('#__content_types'));
			...
			if ($individual_health_education_topic_done)
			{
				...
				$app->enqueueMessage(JText::_('The (com_ehealth_portal.individual_health_education_topic) type alias was removed from the <b>#__content_type</b> table'));
			}
			...
			if ($individual_health_education_topic_done)
			{
				...
				$app->enqueueMessage(JText::_('The (com_ehealth_portal.individual_health_education_topic) type alias was removed from the <b>#__contentitem_tag_map</b> table'));
			}

			// [Interpretation 8349] Remove Individual_health_education_topic items from the ucm content table
			$individual_health_education_topic_condition = array( $db->quoteName('core_type_alias') . ' = ' . $db->quote('com_ehealth_portal.individual_health_education_topic') );
			// [Interpretation 8355] Create a new query object.
			$query = $db->getQuery(true);
			$query->delete($db->quoteName('#__ucm_content'));
			$query->where($individual_health_education_topic_condition);
			...
			if ($individual_health_education_topic_done)
			{
				...
				$app->enqueueMessage(JText::_('The (com_ehealth_portal.individual_health_education_topic) type alias was removed from the <b>#__ucm_content</b> table'));
			}
		...
		$query->where( $db->quoteName('type_alias') . ' = '. $db->quote('com_ehealth_portal.individual_health_education') );
		$db->setQuery($query);
		// [Interpretation 8261] Execute query to see if alias is found
		$db->execute();
		...
		if ($individual_health_education_found)
		{
			...
			$individual_health_education_condition = array( $db->quoteName('type_alias') . ' = '. $db->quote('com_ehealth_portal.individual_health_education') );
			// [Interpretation 8287] Create a new query object.
			$query = $db->getQuery(true);
			$query->delete($db->quoteName('#__content_types'));
			...
			if ($individual_health_education_done)
			{
				...
				$app->enqueueMessage(JText::_('The (com_ehealth_portal.individual_health_education) type alias was removed from the <b>#__content_type</b> table'));
			}
			...
			if ($individual_health_education_done)
			{
				...
				$app->enqueueMessage(JText::_('The (com_ehealth_portal.individual_health_education) type alias was removed from the <b>#__contentitem_tag_map</b> table'));
			}

			// [Interpretation 8349] Remove Individual_health_education items from the ucm content table
			$individual_health_education_condition = array( $db->quoteName('core_type_alias') . ' = ' . $db->quote('com_ehealth_portal.individual_health_education') );
			// [Interpretation 8355] Create a new query object.
			$query = $db->getQuery(true);
			$query->delete($db->quoteName('#__ucm_content'));
			$query->where($individual_health_education_condition);
			...
			if ($individual_health_education_done)
			{
				...
				$app->enqueueMessage(JText::_('The (com_ehealth_portal.individual_health_education) type alias was removed from the <b>#__ucm_content</b> table'));
			}
		...
		$query->where( $db->quoteName('type_alias') . ' = '. $db->quote('com_ehealth_portal.group_health_education') );
		$db->setQuery($query);
		// [Interpretation 8261] Execute query to see if alias is found
		$db->execute();
		...
		if ($group_health_education_found)
		{
			...
			$group_health_education_condition = array( $db->quoteName('type_alias') . ' = '. $db->quote('com_ehealth_portal.group_health_education') );
			// [Interpretation 8287] Create a new query object.
			$query = $db->getQuery(true);
			$query->delete($db->quoteName('#__content_types'));
			...
			if ($group_health_education_done)
			{
				...
				$app->enqueueMessage(JText::_('The (com_ehealth_portal.group_health_education) type alias was removed from the <b>#__content_type</b> table'));
			}
			...
			if ($group_health_education_done)
			{
				...
				$app->enqueueMessage(JText::_('The (com_ehealth_portal.group_health_education) type alias was removed from the <b>#__contentitem_tag_map</b> table'));
			}

			// [Interpretation 8349] Remove Group_health_education items from the ucm content table
			$group_health_education_condition = array( $db->quoteName('core_type_alias') . ' = ' . $db->quote('com_ehealth_portal.group_health_education') );
			// [Interpretation 8355] Create a new query object.
			$query = $db->getQuery(true);
			$query->delete($db->quoteName('#__ucm_content'));
			$query->where($group_health_education_condition);
			...
			if ($group_health_education_done)
			{
				...
				$app->enqueueMessage(JText::_('The (com_ehealth_portal.group_health_education) type alias was removed from the <b>#__ucm_content</b> table'));
			}
		...
		// [Interpretation 8449] Remove ehealth_portal assets from the assets table
		...
		if ($site_done)
		{
			// [Interpretation 8468] If succesfully remove ehealth_portal add queued success message.
	...
	public function preflight($type, JAdapterInstance $parent)
	{
		...
		if (JFile::exists(JPATH_ADMINISTRATOR . '/components/com_ehealth_portal/helpers/PHPExcel.php'))
		{
			// We need to remove this old PHPExcel folder
			$this->removeFolder(JPATH_ADMINISTRATOR . '/components/com_ehealth_portal/helpers/PHPExcel');
			// We need to remove this old PHPExcel file
			JFile::delete(JPATH_ADMINISTRATOR . '/components/com_ehealth_portal/helpers/PHPExcel.php');
		}
		return true;
	}
	...
	public function postflight($type, JAdapterInstance $parent)
	{
		...
		if ($type === 'install')
		{
			...
			$general_medical_check_up->content_history_options = '{"formFile": "administrator/components/com_ehealth_portal/models/forms/general_medical_check_up.xml","hideFields": ["asset_id","checked_out","checked_out_time","version"],"ignoreChanges": ["modified_by","modified","checked_out","checked_out_time","version","hits"],"convertToInt": ["published","ordering","patient","bp_diastolic_one","bp_systolic_one","pulse","bp_diastolic_two","bp_systolic_two","diagnosis","referred_to"],"displayLookup": [{"sourceColumn": "created_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "access","targetTable": "#__viewlevels","targetColumn": "id","displayColumn": "title"},{"sourceColumn": "modified_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "diagnosis","targetTable": "#__ehealth_portal_diagnosis_type","targetColumn": "id","displayColumn": "name"}]}';
			...
			$hiv_counseling_and_testing->content_history_options = '{"formFile": "administrator/components/com_ehealth_portal/models/forms/hiv_counseling_and_testing.xml","hideFields": ["asset_id","checked_out","checked_out_time","version"],"ignoreChanges": ["modified_by","modified","checked_out","checked_out_time","version","hits"],"convertToInt": ["published","ordering","patient","testing_reason"],"displayLookup": [{"sourceColumn": "created_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "access","targetTable": "#__viewlevels","targetColumn": "id","displayColumn": "title"},{"sourceColumn": "modified_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "testing_reason","targetTable": "#__ehealth_portal_testing_reason","targetColumn": "id","displayColumn": "name"}]}';
			...
			$group_health_education_topic->type_title = 'Ehealth_portal Group_health_education_topic';
			$group_health_education_topic->type_alias = 'com_ehealth_portal.group_health_education_topic';
			$group_health_education_topic->table = '{"special": {"dbtable": "#__ehealth_portal_group_health_education_topic","key": "id","type": "Group_health_education_topic","prefix": "ehealth_portalTable","config": "array()"},"common": {"dbtable": "#__ucm_content","key": "ucm_id","type": "Corecontent","prefix": "JTable","config": "array()"}}';
			$group_health_education_topic->field_mappings = '{"common": {"core_content_item_id": "id","core_title": "name","core_state": "published","core_alias": "alias","core_created_time": "created","core_modified_time": "modified","core_body": "null","core_hits": "hits","core_publish_up": "null","core_publish_down": "null","core_access": "access","core_params": "params","core_featured": "null","core_metadata": "null","core_language": "null","core_images": "null","core_urls": "null","core_version": "version","core_ordering": "ordering","core_metakey": "null","core_metadesc": "null","core_catid": "null","core_xreference": "null","asset_id": "asset_id"},"special": {"name":"name","description":"description","alias":"alias"}}';
			$group_health_education_topic->router = 'Ehealth_portalHelperRoute::getGroup_health_education_topicRoute';
			$group_health_education_topic->content_history_options = '{"formFile": "administrator/components/com_ehealth_portal/models/forms/group_health_education_topic.xml","hideFields": ["asset_id","checked_out","checked_out_time","version"],"ignoreChanges": ["modified_by","modified","checked_out","checked_out_time","version","hits"],"convertToInt": ["published","ordering"],"displayLookup": [{"sourceColumn": "created_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "access","targetTable": "#__viewlevels","targetColumn": "id","displayColumn": "title"},{"sourceColumn": "modified_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"}]}';
			...
			$individual_health_education_topic->type_title = 'Ehealth_portal Individual_health_education_topic';
			$individual_health_education_topic->type_alias = 'com_ehealth_portal.individual_health_education_topic';
			$individual_health_education_topic->table = '{"special": {"dbtable": "#__ehealth_portal_individual_health_education_topic","key": "id","type": "Individual_health_education_topic","prefix": "ehealth_portalTable","config": "array()"},"common": {"dbtable": "#__ucm_content","key": "ucm_id","type": "Corecontent","prefix": "JTable","config": "array()"}}';
			$individual_health_education_topic->field_mappings = '{"common": {"core_content_item_id": "id","core_title": "name","core_state": "published","core_alias": "alias","core_created_time": "created","core_modified_time": "modified","core_body": "null","core_hits": "hits","core_publish_up": "null","core_publish_down": "null","core_access": "access","core_params": "params","core_featured": "null","core_metadata": "null","core_language": "null","core_images": "null","core_urls": "null","core_version": "version","core_ordering": "ordering","core_metakey": "null","core_metadesc": "null","core_catid": "null","core_xreference": "null","asset_id": "asset_id"},"special": {"name":"name","description":"description","alias":"alias"}}';
			$individual_health_education_topic->router = 'Ehealth_portalHelperRoute::getIndividual_health_education_topicRoute';
			$individual_health_education_topic->content_history_options = '{"formFile": "administrator/components/com_ehealth_portal/models/forms/individual_health_education_topic.xml","hideFields": ["asset_id","checked_out","checked_out_time","version"],"ignoreChanges": ["modified_by","modified","checked_out","checked_out_time","version","hits"],"convertToInt": ["published","ordering"],"displayLookup": [{"sourceColumn": "created_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "access","targetTable": "#__viewlevels","targetColumn": "id","displayColumn": "title"},{"sourceColumn": "modified_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"}]}';
			...
			$individual_health_education->type_title = 'Ehealth_portal Individual_health_education';
			$individual_health_education->type_alias = 'com_ehealth_portal.individual_health_education';
			$individual_health_education->table = '{"special": {"dbtable": "#__ehealth_portal_individual_health_education","key": "id","type": "Individual_health_education","prefix": "ehealth_portalTable","config": "array()"},"common": {"dbtable": "#__ucm_content","key": "ucm_id","type": "Corecontent","prefix": "JTable","config": "array()"}}';
			...
			$individual_health_education->router = 'Ehealth_portalHelperRoute::getIndividual_health_educationRoute';
			$individual_health_education->content_history_options = '{"formFile": "administrator/components/com_ehealth_portal/models/forms/individual_health_education.xml","hideFields": ["asset_id","checked_out","checked_out_time","version"],"ignoreChanges": ["modified_by","modified","checked_out","checked_out_time","version","hits"],"convertToInt": ["published","ordering","individual_health_edu","patient"],"displayLookup": [{"sourceColumn": "created_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "access","targetTable": "#__viewlevels","targetColumn": "id","displayColumn": "title"},{"sourceColumn": "modified_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "individual_health_edu","targetTable": "#__ehealth_portal_individual_health_education_topic","targetColumn": "id","displayColumn": "name"}]}';
			...
			$group_health_education->type_title = 'Ehealth_portal Group_health_education';
			$group_health_education->type_alias = 'com_ehealth_portal.group_health_education';
			$group_health_education->table = '{"special": {"dbtable": "#__ehealth_portal_group_health_education","key": "id","type": "Group_health_education","prefix": "ehealth_portalTable","config": "array()"},"common": {"dbtable": "#__ucm_content","key": "ucm_id","type": "Corecontent","prefix": "JTable","config": "array()"}}';
			...
			$group_health_education->router = 'Ehealth_portalHelperRoute::getGroup_health_educationRoute';
			$group_health_education->content_history_options = '{"formFile": "administrator/components/com_ehealth_portal/models/forms/group_health_education.xml","hideFields": ["asset_id","checked_out","checked_out_time","version"],"ignoreChanges": ["modified_by","modified","checked_out","checked_out_time","version","hits"],"convertToInt": ["published","ordering","patient","group_health_edu"],"displayLookup": [{"sourceColumn": "created_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "access","targetTable": "#__viewlevels","targetColumn": "id","displayColumn": "title"},{"sourceColumn": "modified_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "group_health_edu","targetTable": "#__ehealth_portal_group_health_education_topic","targetColumn": "id","displayColumn": "name"}]}';
			...
			echo '<a target="_blank" href="https://vdm.io" title="eHealth Portal">
				<img src="components/com_ehealth_portal/assets/images/vdm-component.png"/>
				</a>';
		}
		// do any updates needed
		if ($type === 'update')
