...
--
-- [Interpretation 10670] Always insure this column rules is large enough for all the access control values.
--
ALTER TABLE `#__assets` CHANGE `rules` `rules` TEXT NOT NULL COMMENT 'JSON encoded access control.';

--
-- [Interpretation 10689] Always insure this column name is large enough for long component and view names.
--
