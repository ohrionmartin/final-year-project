 ...
 */
class Eclinic_portalControllerFoetal_presentations extends JControllerAdmin
{
	/**
	 ...
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_ECLINIC_PORTAL_FOETAL_PRESENTATIONS';
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Foetal_presentation', $prefix = 'Eclinic_portalModel', $config = array('ignore_request' => true))
	{
