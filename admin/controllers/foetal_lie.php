 ...
 */
class Eclinic_portalControllerFoetal_lie extends JControllerForm
{
	/**
	...
	protected function allowAdd($data = array())
	{
		...
		$access = $user->authorise('foetal_lie.access', 'com_eclinic_portal');
		if (!$access)
		{
			return false;
		}
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($recordId)
		{
			...
			$permission = $user->authorise('core.edit', 'com_eclinic_portal.foetal_lie.' . (int) $recordId);
			if (!$permission)
			{
				if ($user->authorise('core.edit.own', 'com_eclinic_portal.foetal_lie.' . $recordId))
				{
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_eclinic_portal&view=foetal_lies' . $this->getRedirectToListAppend(), false));
