 ...
 */
class Eclinic_portalControllerDiagnosis_type extends JControllerForm
{
	/**
	...
	protected function allowAdd($data = array())
	{
		...
		$access = $user->authorise('diagnosis_type.access', 'com_eclinic_portal');
		if (!$access)
		{
			return false;
		}
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($recordId)
		{
			...
			$permission = $user->authorise('core.edit', 'com_eclinic_portal.diagnosis_type.' . (int) $recordId);
			if (!$permission)
			{
				if ($user->authorise('core.edit.own', 'com_eclinic_portal.diagnosis_type.' . $recordId))
				{
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_eclinic_portal&view=diagnosis_types' . $this->getRedirectToListAppend(), false));
