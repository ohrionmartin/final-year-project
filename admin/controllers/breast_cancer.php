 ...
 */
class Eclinic_portalControllerBreast_cancer extends JControllerForm
{
	/**
	...
	protected function allowAdd($data = array())
	{
		...
		$access = $user->authorise('breast_cancer.access', 'com_eclinic_portal');
		if (!$access)
		{
			return false;
		}
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($recordId)
		{
			...
			$permission = $user->authorise('core.edit', 'com_eclinic_portal.breast_cancer.' . (int) $recordId);
			if (!$permission)
			{
				if ($user->authorise('core.edit.own', 'com_eclinic_portal.breast_cancer.' . $recordId))
				{
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_eclinic_portal&view=breast_cancers' . $this->getRedirectToListAppend(), false));
