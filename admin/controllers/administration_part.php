 ...
 */
class Eclinic_portalControllerAdministration_part extends JControllerForm
{
	/**
	...
	protected function allowAdd($data = array())
	{
		...
		$access = $user->authorise('administration_part.access', 'com_eclinic_portal');
		if (!$access)
		{
			return false;
		}
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($recordId)
		{
			...
			$permission = $user->authorise('core.edit', 'com_eclinic_portal.administration_part.' . (int) $recordId);
			if (!$permission)
			{
				if ($user->authorise('core.edit.own', 'com_eclinic_portal.administration_part.' . $recordId))
				{
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_eclinic_portal&view=administration_parts' . $this->getRedirectToListAppend(), false));
