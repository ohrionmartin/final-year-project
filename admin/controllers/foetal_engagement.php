 ...
 */
class Eclinic_portalControllerFoetal_engagement extends JControllerForm
{
	/**
	...
	protected function allowAdd($data = array())
	{
		...
		$access = $user->authorise('foetal_engagement.access', 'com_eclinic_portal');
		if (!$access)
		{
			return false;
		}
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($recordId)
		{
			...
			$permission = $user->authorise('core.edit', 'com_eclinic_portal.foetal_engagement.' . (int) $recordId);
			if (!$permission)
			{
				if ($user->authorise('core.edit.own', 'com_eclinic_portal.foetal_engagement.' . $recordId))
				{
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_eclinic_portal&view=foetal_engagements' . $this->getRedirectToListAppend(), false));
