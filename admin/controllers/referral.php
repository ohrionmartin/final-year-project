 ...
 * Referral Controller
 */
class Eclinic_portalControllerReferral extends JControllerForm
{
	/**
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_eclinic_portal&view=referrals' . $this->getRedirectToListAppend(), false));
