 ...
 */
class Eclinic_portalViewNonpay_reason extends JViewLegacy
{
	/**
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = Eclinic_portalHelper::getActions('nonpay_reason', $this->item);
		// get input
	...
	protected function addToolBar()
	{
		...
		else
		{
			...
			else
			{
				...
				{
					JToolbarHelper::versions('com_eclinic_portal.nonpay_reason', $this->item->id);
				}
				if ($this->canDo->get('core.create'))
				{
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_($isNew ? 'COM_ECLINIC_PORTAL_NONPAY_REASON_NEW' : 'COM_ECLINIC_PORTAL_NONPAY_REASON_EDIT'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_eclinic_portal/assets/css/nonpay_reason.css", (Eclinic_portalHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
		...
		$this->document->addScript(JURI::root() . "administrator/components/com_eclinic_portal/views/nonpay_reason/submitbutton.js", (Eclinic_portalHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript'); 
