...
<tr>
	...
	<th class="nowrap hidden-phone" >
			<?php echo JText::_('COM_ECLINIC_PORTAL_VMMC_INTERESTED_IN_VMMC_LABEL'); ?>
	</th>
	<th class="nowrap hidden-phone" >
			<?php echo JText::_('COM_ECLINIC_PORTAL_VMMC_VMMC_GENDER_LABEL'); ?>
	</th>
	...
	<?php else: ?>
		<th width="10" class="nowrap center" >
			<?php echo JText::_('COM_ECLINIC_PORTAL_VMMC_STATUS'); ?>
		</th>
	<?php endif; ?>
