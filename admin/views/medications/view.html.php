...
/**
 * Eclinic_portal View class for the Medications
 */
class Eclinic_portalViewMedications extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		if ($this->getLayout() !== 'modal')
		{
			...
			Eclinic_portalHelper::addSubmenu('medications');
		}
	...
	{
		JToolBarHelper::title(JText::_('COM_ECLINIC_PORTAL_MEDICATIONS'), 'joomla');
		JHtmlSidebar::setAction('index.php?option=com_eclinic_portal&view=medications');
		...
		if (Eclinic_portalHelper::checkArray($this->items))
		{
			...
			{
				JToolBarHelper::custom('medications.exportData', 'download', '', 'COM_ECLINIC_PORTAL_EXPORT_DATA', true);
			}
		}

		if ($this->canDo->get('core.import') && $this->canDo->get('medication.import'))
		{
			JToolBarHelper::custom('medications.importData', 'upload', '', 'COM_ECLINIC_PORTAL_IMPORT_DATA', false);
		}

		// set help url for this view if found
		$help_url = Eclinic_portalHelper::getHelpUrl('medications');
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_('COM_ECLINIC_PORTAL_MEDICATIONS'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_eclinic_portal/assets/css/medications.css", (Eclinic_portalHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => JText::_('COM_ECLINIC_PORTAL_MEDICATION_NAME_LABEL'),
			'a.description' => JText::_('COM_ECLINIC_PORTAL_MEDICATION_DESCRIPTION_LABEL'),
