...
<div class="form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'general_medical_check_upTab', 'vital_signs', JText::_('COM_ECLINIC_PORTAL_GENERAL_MEDICAL_CHECK_UP_VITAL_SIGNS', true)); ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'general_medical_check_upTab', 'diagnosis', JText::_('COM_ECLINIC_PORTAL_GENERAL_MEDICAL_CHECK_UP_DIAGNOSIS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
		</div>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'general_medical_check_upTab', 'referrals', JText::_('COM_ECLINIC_PORTAL_GENERAL_MEDICAL_CHECK_UP_REFERRALS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'general_medical_check_upTab', 'dispensing', JText::_('COM_ECLINIC_PORTAL_GENERAL_MEDICAL_CHECK_UP_DISPENSING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
		</div>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'general_medical_check_upTab', 'publishing', JText::_('COM_ECLINIC_PORTAL_GENERAL_MEDICAL_CHECK_UP_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'general_medical_check_upTab', 'permissions', JText::_('COM_ECLINIC_PORTAL_GENERAL_MEDICAL_CHECK_UP_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
...
/***[JCBGUI.admin_view.javascript_view_footer.110.$$$$]***/
