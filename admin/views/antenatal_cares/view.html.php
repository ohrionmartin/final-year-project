...
class Eclinic_portalViewAntenatal_cares extends JViewLegacy
{
	...
	protected function addToolBar()
	{
		...
		// [Interpretation 18524] Only load Foetal Lie Name batch if create, edit, and batch is allowed
		if ($this->canBatch && $this->canCreate && $this->canEdit)
		{
			// [Interpretation 18537] Set Foetal Lie Name Selection
			$this->foetal_lieNameOptions = JFormHelper::loadFieldType('Foetallie')->options;
			// [Interpretation 18543] We do some sanitation for Foetal Lie Name filter
			...
			// [Interpretation 18562] Foetal Lie Name Batch Selection
			JHtmlBatch_::addListSelection(
