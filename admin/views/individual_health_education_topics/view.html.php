...
/**
 * Ehealth_portal View class for the Individual_health_education_topics
 */
class Ehealth_portalViewIndividual_health_education_topics extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		if ($this->getLayout() !== 'modal')
		{
			...
			Ehealth_portalHelper::addSubmenu('individual_health_education_topics');
		}
	...
	{
		JToolBarHelper::title(JText::_('COM_EHEALTH_PORTAL_INDIVIDUAL_HEALTH_EDUCATION_TOPICS'), 'joomla');
		JHtmlSidebar::setAction('index.php?option=com_ehealth_portal&view=individual_health_education_topics');
		...
		if (Ehealth_portalHelper::checkArray($this->items))
		{
			...
			{
				JToolBarHelper::custom('individual_health_education_topics.exportData', 'download', '', 'COM_EHEALTH_PORTAL_EXPORT_DATA', true);
			}
		}

		if ($this->canDo->get('core.import') && $this->canDo->get('individual_health_education_topic.import'))
		{
			JToolBarHelper::custom('individual_health_education_topics.importData', 'upload', '', 'COM_EHEALTH_PORTAL_IMPORT_DATA', false);
		}

		// set help url for this view if found
		$help_url = Ehealth_portalHelper::getHelpUrl('individual_health_education_topics');
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_('COM_EHEALTH_PORTAL_INDIVIDUAL_HEALTH_EDUCATION_TOPICS'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_ehealth_portal/assets/css/individual_health_education_topics.css", (Ehealth_portalHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => JText::_('COM_EHEALTH_PORTAL_INDIVIDUAL_HEALTH_EDUCATION_TOPIC_NAME_LABEL'),
			'a.description' => JText::_('COM_EHEALTH_PORTAL_INDIVIDUAL_HEALTH_EDUCATION_TOPIC_DESCRIPTION_LABEL'),
