 ...
 */
class Ehealth_portalViewGroup_health_education extends JViewLegacy
{
	/**
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = Ehealth_portalHelper::getActions('group_health_education', $this->item);
		// get input
	...
	protected function addToolBar()
	{
		...
		JToolbarHelper::title( JText::_($isNew ? 'COM_EHEALTH_PORTAL_GROUP_HEALTH_EDUCATION_NEW' : 'COM_EHEALTH_PORTAL_GROUP_HEALTH_EDUCATION_EDIT'), 'pencil-2 article-add');
		...
		else
		{
			...
			else
			{
				...
				{
					JToolbarHelper::versions('com_ehealth_portal.group_health_education', $this->item->id);
				}
				if ($this->canDo->get('core.create'))
				{
		...
		$help_url = Ehealth_portalHelper::getHelpUrl('group_health_education');
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_($isNew ? 'COM_EHEALTH_PORTAL_GROUP_HEALTH_EDUCATION_NEW' : 'COM_EHEALTH_PORTAL_GROUP_HEALTH_EDUCATION_EDIT'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_ehealth_portal/assets/css/group_health_education.css", (Ehealth_portalHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
		...
		$this->document->addScript(JURI::root() . "administrator/components/com_ehealth_portal/views/group_health_education/submitbutton.js", (Ehealth_portalHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript'); 
