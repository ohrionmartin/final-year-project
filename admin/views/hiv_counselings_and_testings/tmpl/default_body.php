...
$edit = "index.php?option=com_eclinic_portal&view=hiv_counselings_and_testings&task=hiv_counseling_and_testing.edit";
...
<?php foreach ($this->items as $i => $item): ?>
	<?php
		...
		$canDo = Eclinic_portalHelper::getActions('hiv_counseling_and_testing',$item,'hiv_counselings_and_testings');
	?>
