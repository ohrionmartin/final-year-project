...
<div class="form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'immunisationTab', 'details', JText::_('COM_ECLINIC_PORTAL_IMMUNISATION_DETAILS', true)); ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'immunisationTab', 'publishing', JText::_('COM_ECLINIC_PORTAL_IMMUNISATION_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'immunisationTab', 'permissions', JText::_('COM_ECLINIC_PORTAL_IMMUNISATION_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
