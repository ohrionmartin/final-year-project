...
class Eclinic_portalViewPayments extends JViewLegacy
{
	...
	protected function addToolBar()
	{
		...
		// [Interpretation 18583] Only load Payment Category batch if create, edit, and batch is allowed
		if ($this->canBatch && $this->canCreate && $this->canEdit)
		{
			// [Interpretation 18593] Set Payment Category Selection
			$this->payment_categoryOptions = JFormHelper::loadFieldType('paymentsfilterpaymentcategory')->options;
			// [Interpretation 18601] We do some sanitation for Payment Category filter
			...
			// [Interpretation 18618] Payment Category Batch Selection
			JHtmlBatch_::addListSelection(
