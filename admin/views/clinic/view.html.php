 ...
 * Clinic View class
 */
class Eclinic_portalViewClinic extends JViewLegacy
{
	/**
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = Eclinic_portalHelper::getActions('clinic', $this->item);
		// get input
	...
	protected function addToolBar()
	{
		...
		JToolbarHelper::title( JText::_($isNew ? 'COM_ECLINIC_PORTAL_CLINIC_NEW' : 'COM_ECLINIC_PORTAL_CLINIC_EDIT'), 'pencil-2 article-add');
		...
		else
		{
			...
			else
			{
				...
				{
					JToolbarHelper::versions('com_eclinic_portal.clinic', $this->item->id);
				}
				if ($this->canDo->get('core.create'))
				{
		...
		$help_url = Eclinic_portalHelper::getHelpUrl('clinic');
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_($isNew ? 'COM_ECLINIC_PORTAL_CLINIC_NEW' : 'COM_ECLINIC_PORTAL_CLINIC_EDIT'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_eclinic_portal/assets/css/clinic.css", (Eclinic_portalHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
		...
		$this->document->addScript(JURI::root() . "administrator/components/com_eclinic_portal/views/clinic/submitbutton.js", (Eclinic_portalHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript'); 
