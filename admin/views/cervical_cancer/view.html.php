 ...
 */
class Eclinic_portalViewCervical_cancer extends JViewLegacy
{
	/**
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = Eclinic_portalHelper::getActions('cervical_cancer', $this->item);
		// get input
	...
	protected function addToolBar()
	{
		...
		JToolbarHelper::title( JText::_($isNew ? 'COM_ECLINIC_PORTAL_CERVICAL_CANCER_NEW' : 'COM_ECLINIC_PORTAL_CERVICAL_CANCER_EDIT'), 'pencil-2 article-add');
		...
		else
		{
			...
			else
			{
				...
				{
					JToolbarHelper::versions('com_eclinic_portal.cervical_cancer', $this->item->id);
				}
				if ($this->canDo->get('core.create'))
				{
		...
		$help_url = Eclinic_portalHelper::getHelpUrl('cervical_cancer');
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_($isNew ? 'COM_ECLINIC_PORTAL_CERVICAL_CANCER_NEW' : 'COM_ECLINIC_PORTAL_CERVICAL_CANCER_EDIT'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_eclinic_portal/assets/css/cervical_cancer.css", (Eclinic_portalHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
		...
		$this->document->addScript(JURI::root() . "administrator/components/com_eclinic_portal/views/cervical_cancer/submitbutton.js", (Eclinic_portalHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript'); 
