...
<div class="form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'vmmcTab', 'details', JText::_('COM_ECLINIC_PORTAL_VMMC_DETAILS', true)); ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'vmmcTab', 'publishing', JText::_('COM_ECLINIC_PORTAL_VMMC_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'vmmcTab', 'permissions', JText::_('COM_ECLINIC_PORTAL_VMMC_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
