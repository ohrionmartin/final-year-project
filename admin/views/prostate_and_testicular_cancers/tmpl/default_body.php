...
$edit = "index.php?option=com_eclinic_portal&view=prostate_and_testicular_cancers&task=prostate_and_testicular_cancer.edit";
...
<?php foreach ($this->items as $i => $item): ?>
	<?php
		...
		$canDo = Eclinic_portalHelper::getActions('prostate_and_testicular_cancer',$item,'prostate_and_testicular_cancers');
	?>
