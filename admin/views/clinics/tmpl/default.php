...
if ($this->saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_eclinic_portal&task=clinics.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'clinicList', 'adminForm', strtolower($this->listDirn), $saveOrderingUrl);
}
?>
<form action="<?php echo JRoute::_('index.php?option=com_eclinic_portal&view=clinics'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php else : ?>
	...
	<?php if ($this->canCreate && $this->canEdit) : ?>
		<?php echo JHtml::_(
			...
			'collapseModal',
			array(
				'title' => JText::_('COM_ECLINIC_PORTAL_CLINICS_BATCH_OPTIONS'),
