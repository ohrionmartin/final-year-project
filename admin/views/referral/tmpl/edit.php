...
<div class="form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'referralTab', 'details', JText::_('COM_ECLINIC_PORTAL_REFERRAL_DETAILS', true)); ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'referralTab', 'publishing', JText::_('COM_ECLINIC_PORTAL_REFERRAL_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'referralTab', 'permissions', JText::_('COM_ECLINIC_PORTAL_REFERRAL_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
