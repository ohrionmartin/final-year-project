 ...
 */
class Eclinic_portalTableFoetal_presentation extends JTable
{
	/**
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_ECLINIC_PORTAL_FOETAL_PRESENTATION_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_eclinic_portal.foetal_presentation.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_eclinic_portal.foetal_presentation.'.(int) $this->$k;
	}
