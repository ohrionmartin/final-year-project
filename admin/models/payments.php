...
class Ehealth_portalModelPayments extends JModelList
{
	...
	public function getItems()
	{
		...
		if (Ehealth_portalHelper::checkArray($items))
		{
			...
			{
				// [Interpretation 21036] convert payment_category
				$item->payment_category = $this->selectionTranslation($item->payment_category, 'payment_category');
				// [Interpretation 21036] convert payment_amount
	...
	{
		// [Interpretation 21076] Array of payment_category language strings
	...
	protected function getListQuery()
	{
		...
		// [Interpretation 15382] From the ehealth_portal_payment_type table.
		...
		// [Interpretation 15382] From the ehealth_portal_nonpay_reason table.
		...
		// [Interpretation 15454] Filter by Payment_category.
		if ($payment_category = $this->getState('filter.payment_category'))
		{
			$query->where('a.payment_category = ' . $db->quote($db->escape($payment_category)));
		}
	...
	public function getExportData($pks, $user = null)
	{
		...
		if (($pks_size = Ehealth_portalHelper::checkArray($pks)) !== false || 'bulk' === $pks)
		{
			...
			// [Interpretation 14528] From the ehealth_portal_payment table
			$query->from($db->quoteName('#__ehealth_portal_payment', 'a'));
