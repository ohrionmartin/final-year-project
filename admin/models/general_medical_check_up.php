...
class Eclinic_portalModelGeneral_medical_check_up extends JModelAdmin
{
	...
	public function getItem($pk = null)
	{
		if ($item = parent::getItem($pk))
		{
			...
			{
				// [Interpretation 7421] Convert the dispensing field to an array.
	...
	public function save($data)
	{
		...
		// [Interpretation 7487] Set the empty chronic_medication item to data
		if (!isset($data['chronic_medication']))
		{
			$data['chronic_medication'] = '';
		}

		// [Interpretation 7521] Set the dispensing items to data.
		...
		{
			// [Interpretation 7571] Set the empty dispensing to data
			$data['dispensing'] = '';
		}
