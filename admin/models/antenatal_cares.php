...
class Eclinic_portalModelAntenatal_cares extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		// [Interpretation 15439] Filter by foetal_lie.
		if ($foetal_lie = $this->getState('filter.foetal_lie'))
		{
			$query->where('a.foetal_lie = ' . $db->quote($db->escape($foetal_lie)));
		}
