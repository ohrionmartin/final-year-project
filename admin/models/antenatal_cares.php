...
class Eclinic_portalModelAntenatal_cares extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		// [Interpretation 15852] From the eclinic_portal_foetal_lie table.
		...
		// [Interpretation 15852] From the eclinic_portal_foetal_presentation table.
		...
		// [Interpretation 15852] From the eclinic_portal_foetal_engagement table.
		...
		// [Interpretation 15921] Filter by Foetal_lie.
		...
		elseif (Eclinic_portalHelper::checkString($_foetal_lie))
		{
	...
	public function getExportData($pks, $user = null)
	{
		...
		if (($pks_size = Eclinic_portalHelper::checkArray($pks)) !== false || 'bulk' === $pks)
		{
			...
			// [Interpretation 15018] From the eclinic_portal_antenatal_care table
			$query->from($db->quoteName('#__eclinic_portal_antenatal_care', 'a'));
