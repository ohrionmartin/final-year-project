...
class Eclinic_portalModelVmmcs extends JModelList
{
	...
	{
		// [Interpretation 22408] Array of are_you_circumcised language strings
		...
		// [Interpretation 22408] Array of info_ben_vmcc language strings
		...
		// [Interpretation 22408] Array of interested_in_vmmc language strings
		...
		// [Interpretation 22408] Array of vmmc_gender language strings
		if ($name === 'vmmc_gender')
		{
	...
	public function getExportData($pks, $user = null)
	{
		...
		if (($pks_size = Eclinic_portalHelper::checkArray($pks)) !== false || 'bulk' === $pks)
		{
			...
			// [Interpretation 15018] From the eclinic_portal_vmmc table
			$query->from($db->quoteName('#__eclinic_portal_vmmc', 'a'));
