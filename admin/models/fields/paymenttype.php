...
class JFormFieldPaymenttype extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		if ($set_button === 'true')
		{
			...
			// [Fields 6095] only add if user allowed to create payment_type
			...
			// [Fields 6131] only add if user allowed to edit payment_type
			...
			// [Fields 6206] check if button was created for payment_type field.
