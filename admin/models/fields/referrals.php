...
class JFormFieldReferrals extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		if ($set_button === 'true')
		{
			...
			// [Fields 5470] only add if user allowed to create referral
			...
			// [Fields 5506] only add if user allowed to edit referral
			...
			// [Fields 5581] check if button was created for referral field.
