...
class JFormFieldFoetallie extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		if ($set_button === 'true')
		{
			...
			// [Fields 6095] only add if user allowed to create foetal_lie
			...
			// [Fields 6131] only add if user allowed to edit foetal_lie
			...
			// [Fields 6206] check if button was created for foetal_lie field.
