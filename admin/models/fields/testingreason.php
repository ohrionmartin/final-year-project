...
class JFormFieldTestingreason extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		if ($set_button === 'true')
		{
			...
			// [Fields 6095] only add if user allowed to create testing_reason
			...
			// [Fields 6131] only add if user allowed to edit testing_reason
			...
			// [Fields 6206] check if button was created for testing_reason field.
