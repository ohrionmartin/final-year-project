...
/-------------------------------------------------------------------------------------------------------/
	...
	@subpackage		individualhealtheducationsfilterpatient.php
...
/**
 * Individualhealtheducationsfilterpatient Form Field class for the Eclinic_portal component
 */
class JFormFieldIndividualhealtheducationsfilterpatient extends JFormFieldList
{
	/**
	 * The individualhealtheducationsfilterpatient field type.
	 *
	 * @var		string
	 */
	public $type = 'individualhealtheducationsfilterpatient';
