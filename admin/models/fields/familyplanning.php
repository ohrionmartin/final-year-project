...
class JFormFieldFamilyplanning extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		if ($set_button === 'true')
		{
			...
			// [Fields 5470] only add if user allowed to create planning_type
			...
			// [Fields 5506] only add if user allowed to edit planning_type
			...
			// [Fields 5581] check if button was created for planning_type field.
