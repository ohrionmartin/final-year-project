...
/-------------------------------------------------------------------------------------------------------/
	...
	@subpackage		grouphealtheducationsfilterpatient.php
...
/**
 * Grouphealtheducationsfilterpatient Form Field class for the Eclinic_portal component
 */
class JFormFieldGrouphealtheducationsfilterpatient extends JFormFieldList
{
	/**
	 * The grouphealtheducationsfilterpatient field type.
	 *
	 * @var		string
	 */
	public $type = 'grouphealtheducationsfilterpatient';
