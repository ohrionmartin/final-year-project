...
class JFormFieldNonpayreason extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		if ($set_button === 'true')
		{
			...
			// [Fields 5470] only add if user allowed to create nonpay_reason
			...
			// [Fields 5506] only add if user allowed to edit nonpay_reason
			...
			// [Fields 5581] check if button was created for nonpay_reason field.
