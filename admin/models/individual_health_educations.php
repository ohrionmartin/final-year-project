...
class Eclinic_portalModelIndividual_health_educations extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		// [Interpretation 15382] From the eclinic_portal_individual_health_education_topic table.
	...
	public function getExportData($pks, $user = null)
	{
		...
		if (($pks_size = Eclinic_portalHelper::checkArray($pks)) !== false || 'bulk' === $pks)
		{
			...
			// [Interpretation 14528] From the eclinic_portal_individual_health_education table
			$query->from($db->quoteName('#__eclinic_portal_individual_health_education', 'a'));
