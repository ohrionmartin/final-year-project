...
class Eclinic_portalModelVmmc extends JModelAdmin
{
	...
	{
		// [Interpretation 17531] check if the not_required field is set
		if (isset($data['not_required']) && Eclinic_portalHelper::checkString($data['not_required']))
		{
			$requiredFields = (array) explode(',',(string) $data['not_required']);
			$requiredFields = array_unique($requiredFields);
			// [Interpretation 17541] now change the required field attributes value
			foreach ($requiredFields as $requiredField)
			{
				// [Interpretation 17546] make sure there is a string value
				if (Eclinic_portalHelper::checkString($requiredField))
				{
					// [Interpretation 17551] change to false
					$form->setFieldAttribute($requiredField, 'required', 'false');
					// [Interpretation 17555] also clear the data set
					$data[$requiredField] = '';
				}
			}
		}
